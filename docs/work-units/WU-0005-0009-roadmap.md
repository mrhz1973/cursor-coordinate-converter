...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`e7d9398`** / **`B6.0E-FIX8 · build 75`**. **MAJOR-3-b2** resta parcheggiato. Backlog: **OUTDOOR-ROUTING-REVERSE-A**, **TRACK-ELEVATION-PROFILE-A**, **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**.
...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-REVERSE-A — backlog / non aperto:** Pulsante Inverti percorso (swap A/B; invert via; profilo/opzioni; ricalcolo esplicito; OPSEC/forced-offline; i18n IT/EN/FR).
  - **TRACK-ELEVATION-PROFILE-A / OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A — backlog / non aperti** (registrati in chiusura Bundle E).
  - **Prossimo ordine operativo:** **OUTDOOR-ROUTING-REVERSE-A** / backlog routing UX / **TRACK-ELEVATION-PROFILE-A** / **POINT-UNDO-A** / **UNITS-A** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A**. Runtime live monolite **OUTDOOR-ROUTING-GH-E** tip **`e7d9398`** build 75; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**.
