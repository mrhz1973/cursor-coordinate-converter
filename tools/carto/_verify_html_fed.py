...
print("build IIM", "CARTO-IIM-PROVIDER-A" in t, "num230", "const APP_BUILD_NUM = 230" in t)
print("old combined block leftover", "CARTO-IIM-UKHO-PROVIDERS-A" in t, "num229", "const APP_BUILD_NUM = 229" in t)
print("FIX6 leftover", "OUTDOOR-ROUTING-F-PROVIDER-COMPARE-A-FIX6" in t)
print("end marker", "runSelfCheck" in t, t[-80:].replace("\n","\\n")[:80])
for eid in ("cartoIgmEmbeddedData", "cartoIimEmbeddedData"):
...
print("ukho tag", "cartoUkhoEmbeddedData" in t)
