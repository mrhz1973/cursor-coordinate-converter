...
1. **GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1** — **LIVE** build **247** tip `ac4789e` · blob `6e10d568…` · deploy+ABQA PASS · **QA FINALE PENDING** (2026-08-21); FIX1 template leak; **Oggetti GIS FROZEN / MAINTENANCE-ONLY**
...
- **Policy 2026-08-21:** **Oggetti GIS = FROZEN / MAINTENANCE-ONLY** (accesso via Impostazioni da `GIS-OBJECTS-SETTINGS-RELEGATE-A` + **FIX1** LIVE **247**); no nuovi sviluppi funzionali; bugfix/stabilità OK; backlog espansione funzionale **non** auto-NEXT; storico preservato
- **Backlog 2026-08-21:** `GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1` — **LIVE** build **247** tip `ac4789e` · blob `6e10d568…` · QA FINALE PENDING; evidence [`orchestrator/inbox/2026-08-21_2245_GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1_deploy-abqa.md`](orchestrator/inbox/2026-08-21_2245_GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1_deploy-abqa.md)
