...
- Blocchi futuri:
  ...
  - **P-POLYGON-LIST-UX-NEXT — backlog candidato (non WU aperta):** colonne tabella Poligoni ridimensionabili manualmente; rinomina inline sulla cella Nome (senza barra separata). Emerso da QA FIX2 — non blocca P-POLYGON-LIST-ENRICHMENT CLOSED.
