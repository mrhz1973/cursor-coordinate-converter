...
- **Bundle 2026-08-22:** `GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A` — IMPLEMENTED · deploy PASS · ABQA 18/18 · **QA FINALE PENDING**; candidate **248** tip `aa6e8f5` · blob `dadbf8af…`; consuma `GIS-WAYPOINT-MODAL-LAYOUT-A` + `GIS-POLYGON-METRICS-COMPACT-FORMAT-A` (storico backlog preservato); evidence [`orchestrator/inbox/2026-08-22_0045_GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A_deploy-abqa.md`](orchestrator/inbox/2026-08-22_0045_GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A_deploy-abqa.md)
