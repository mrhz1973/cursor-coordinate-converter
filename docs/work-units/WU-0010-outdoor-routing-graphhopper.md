...
**RUNTIME CANDIDATE:** build **221** · `OUTDOOR-ROUTING-F-PROVIDER-COMPARE-A` · blob `90c52d57f58ec49af91bf0364e2fe7c8aa5ece3b`
...
**OUTDOOR-ROUTING-F-PROVIDER-COMPARE-A:** **CANDIDATE / REVIEW GPT-SOSTITUTIVA — PENDING** (2026-08-18) — build **221** · blob `90c52d57…` · bytes LF **10605066** · SHA-256 LF **`72a8ed24…`**; confronto opt-in GH vs ORS nello stesso planner; coppie `hiking`↔`foot-hiking` e `mtb_trail`↔`cycling-mountain`; `hiking_easy` / `mtb_touring` / `foot-walking` **non confrontabili**; LIVE resta **220**. Evidence: [`2026-08-18_1259_outdoor-routing-f-provider-compare-a-evidence.md`](../orchestrator/inbox/2026-08-18_1259_outdoor-routing-f-provider-compare-a-evidence.md).
...
**Backlog UX:** **QA-OPERATOR-IT-ONLY-PREF CLOSED / PASS docs-only** (2026-08-01). **Oggetti GIS FROZEN**. **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**. **ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1–FIX3) CLOSED**. **ROUTING-GEOCODE-SNAP-A CLOSED**. **ROUTING-SEARCH-UX-A CLOSED** (nel bundle UX-SEARCH-ERROR-FOCUS-A). **UI-MODAL-ERROR-FOCUS-A CLOSED** + **FIX1/FIX2 CLOSED**. **UX-SEARCH-ERROR-FOCUS-A CLOSED / PASS end-to-end**. **ROUTING-MODAL-OPEN-EXPANDED-A (+ FIX1) CLOSED / PASS end-to-end**. **ROUTING-ANDATA-RITORNO-A CLOSED / PASS end-to-end**. **ROUTING-ACTION-ROW-UX-A CLOSED / PASS end-to-end**. **ROUTING-ANELLO-A (+ FIX1) CLOSED / PASS end-to-end**. **OUTDOOR-ROUTING-F-AVOID-AREAS-A (+ FIX1) CLOSED / PASS end-to-end**. **OUTDOOR-ROUTING-ORS-PROVIDER-A CLOSED / PASS end-to-end**. **OUTDOOR-ROUTING-F-PROVIDER-COMPARE-A REVIEW GPT-SOSTITUTIVA — PENDING** (candidate 221).
