...
| **F** | Workspace due legende a destra | **OPEN** → `GIS-WORKSPACE-LEGENDS-F-BATCH1` + **FIX1** LIVE `f1dd580` / **216** · ABQA PASS · gate **QA FINALE CHATGPT — PENDING** |
...
**Stato:** **OPEN** — `GIS-WORKSPACE-LEGENDS-F-BATCH1` + **FIX1** LIVE `f1dd580` / build **216** · QA operatore FAIL su 215 (solo D-Flight non a destra) · FIX1 ABQA PASS · gate **QA FINALE CHATGPT — PENDING**.
