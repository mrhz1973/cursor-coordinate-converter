...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** resto **Bundle F** / da scegliere. Runtime live monolite **ROUTING-MODAL-OPEN-EXPANDED-A-FIX1** tip **`89a08fb`** build 109; GH VPS **V3**; **ROUTING-MODAL-OPEN-EXPANDED-A (+ FIX1) CLOSED**; **UX-SEARCH-ERROR-FOCUS-A CLOSED** (superseded live); **ROUTING-GEOCODE-SNAP-A CLOSED** (superseded live); **L10N-EN-FR-FREEZE-A CLOSED**; **ROUTING-ALTERNATIVE-ROUTES-A CLOSED** (superseded live); **QA-CHATGPT-3LINE-CURSOR-RULES-A CLOSED**; **QA-CHATGPT-3LINE-HANDOFF-PREF CLOSED**; **QA-OPERATOR-IT-ONLY-PREF CLOSED**; **Oggetti GIS FROZEN**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) CLOSED**; **ROUTING-POINT-COORD-EDIT-A (+ FIX1) CLOSED**; **TRACK-POINT-CENTER-BUTTON-A CLOSED**; **MAJOR-3-b2 (+ FIX1) CLOSED**; **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**.
  - **ROUTING-MODAL-OPEN-EXPANDED-A (+ FIX1) build 109 — CLOSED / PASS end-to-end:** tip **`89a08fb`**; blob **`a1ad55e5…`**; byte LF **3287946**; SHA-256 LF **`235ea017…`**; catena `ae28eec` (A · 108) → FIX1; altezza max + width operativa 680; QA FAIL A → FIX1; review+deploy+QA PASS; display **`ROUTING-MODAL-OPEN-EXPANDED-A-FIX1 · build 109`**.
  - **UX-SEARCH-ERROR-FOCUS-A build 107 — CLOSED / PASS end-to-end:** tip storico **`0b27e27`**; blob **`c56b4a35…`**; byte LF **3285428**; SHA-256 LF **`25988cb5…`**; bundle ROUTINE chiude **ROUTING-SEARCH-UX-A** + **UI-MODAL-ERROR-FOCUS-A**; harness 38/38; deploy+QA PASS; **superseded live** da **ROUTING-MODAL-OPEN-EXPANDED-A-FIX1**.
