...
| **BLOCCO ATTIVO** | D-FLIGHT-ATM09-LEGEND-UX-RULE-META-DESIGN-A (**CLOSED / PASS**) |
| **STATO BLOCCO** | **CLOSED / PASS** — design/docs-only; nessuna patch runtime/helper; nessun probe eseguito |
| **GATE CORRENTE** | **DELICATE RULE-META PROBE REVIEW REQUIRED** |
...
| **NEXT** | specifica/prompt one-shot RULE-META PROBE DELICATO → review OM §4 Regola B **prima** esecuzione (NON IMPL-A) |
