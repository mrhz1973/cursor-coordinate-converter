...
- Blocchi futuri:
  ...
  - **BATCH FEATURE POLIGONI — P-UI-UNIFORM** layout pannello Poligoni (HTML/CSS only, pattern Range & Bearing): **runtime pubblicato**, deploy/QA pending, **non CLOSED**; **P-UNITS** / **P-VERTEX-MODAL** / **P-STYLE** non iniziati;
