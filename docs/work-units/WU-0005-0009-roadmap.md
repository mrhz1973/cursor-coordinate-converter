...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b CLOSED / B2 READY**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B CLOSED / PASS**; endpoint VPS `http://100.114.7.53:8989`; prossimo bundle autorizzabile **B2** (endpoint resolution + POST `/route` + preview; **DELICATO**; review pre-deploy). Runtime live monolite **`ff43878`** build 59. **MAJOR-3-b2** resta parcheggiato.
...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** **OUTDOOR-ROUTING-GH-B2** (**READY** — endpoint VPS disponibile; WU-0010 **OPEN / B1a+B1b CLOSED**; **INFRA-GH-1A/1B CLOSED**). **MAJOR-3-b2** resta **parcheggiato**; runtime live **TRACK-POINT-CAP-2000** tip **`ff43878`** build 59; backlog UX **TRACK-POINT-CENTER-BUTTON-A** (NON APERTO).
