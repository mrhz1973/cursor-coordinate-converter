...
| **RUNTIME CANDIDATE** | build **220** · `OUTDOOR-ROUTING-ORS-PROVIDER-A` · monolite patched (non deployato) |
| **NEXT** | review GPT-sostitutiva candidate 220 · poi deploy/ABQA/QA se autorizzato |
