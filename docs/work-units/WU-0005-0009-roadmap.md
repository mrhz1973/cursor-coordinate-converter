...
| **D** | Legenda ATM09 esterna | **OPEN** → [`WU-0018`](WU-0018-dflight-atm09-legend-ux.md) — STYLE-META-CLOSE-A **CLOSED/PASS** (M2) · COSTA≡rosso **IDENTICAL** · INFO costa/italia **0** · user-facing **7/8** · gate **ATM09 STYLE METADATA SOURCE REQUIRED** · NEXT = residui costa + secondo Max 120 |
