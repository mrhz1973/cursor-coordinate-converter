...
- Blocchi futuri:
  ...
  - **ROUTING-PROFILE-EDIT-A / TRACK-PROFILE-POINTS-DISPLAY-A / MAP-CENTER-VIEWPORT-AWARE-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  - **APP-BUILD-LABEL-UX-A (+ FIX1) build 88 — CLOSED / PASS end-to-end:** catena **`6de0e98`** (87) → tip **`da3397b`** (88 FIX1); blob **`f028f390…`**; byte LF **3139603**; SHA-256 LF **`49d4db86…`**; HUD testuale rimossa + footer GIS stabile; QA FAIL A → FIX1; deploy GIS-only PASS; **QA PASS** «**QA APP-BUILD-LABEL-UX-A-FIX1 PASS operatore**»; display **`B6.2BL-A-FIX1 · build 88`**.
  - **OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A — CLOSED / ASSORBITI** in ROUTING-UX-POLISH-BUNDLE-A (+ FIX1).
  - **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) build 86 — CLOSED / PASS end-to-end:** catena **`7653ee7`** (85) → tip storico **`173b6cb`** (86 FIX1); blob **`9686245e…`**; byte LF **3150227**; SHA-256 LF **`4c197243…`**; undo storico + unità session + feedback + badge + focus; deploy GIS-only PASS; **QA PASS** «**QA ROUTING-UX-POLISH-BUNDLE-A-FIX1 PASS operatore**»; display **`B6.2UX-A-FIX1 · build 86`**; superseded live da APP-BUILD-LABEL.
  ...
  - **Prossimo ordine operativo:** backlog UX profilo (PROFILE-EDIT / POINTS-DISPLAY / MAP-CENTER) / **QA-OPERATOR-IT-ONLY-PREF** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **APP-BUILD-LABEL-UX-A-FIX1** tip **`da3397b`** build 88; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**.
