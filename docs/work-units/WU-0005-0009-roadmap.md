...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A+TRACK-SAVE-AS-NAME-A+ROUTING-SUMMARY-DEDUP-A+ROUTING-UX-POLISH-BUNDLE-A (+ FIX1)+APP-BUILD-LABEL-UX-A (+ FIX1)+TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`3838e9e`** / **`B6.2TPD-A · build 89`** (**TRACK-PROFILE-POINTS-DISPLAY-A** CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **ROUTING-PROFILE-EDIT-A**, **MAP-CENTER-VIEWPORT-AWARE-A**, ….
...
- Blocchi futuri:
  ...
  - **ROUTING-PROFILE-EDIT-A / MAP-CENTER-VIEWPORT-AWARE-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  - **TRACK-PROFILE-POINTS-DISPLAY-A build 89 — CLOSED / PASS end-to-end:** tip **`3838e9e`**; blob **`48abde62…`**; byte LF **3144095**; SHA-256 LF **`464eed94…`**; overlay punti Profilo max 120 distance-decimated; review downstream PASS; deploy GIS-only PASS; **QA PASS** «**QA TRACK-PROFILE-POINTS-DISPLAY-A PASS operatore**»; display **`B6.2TPD-A · build 89`**.
  ...
  - **Prossimo ordine operativo:** backlog UX profilo (PROFILE-EDIT / MAP-CENTER) / **QA-OPERATOR-IT-ONLY-PREF** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **TRACK-PROFILE-POINTS-DISPLAY-A** tip **`3838e9e`** build 89; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**.
