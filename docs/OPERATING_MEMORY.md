...
| **BLOCCO ATTIVO** | D-FLIGHT-ATM09-LEGEND-UX-REFERENCE-C (**CLOSED / PASS**) |
...
| **NEXT** | join TECH↔pattern UI ufficiale (rosse_scure/piene GLG identici; rosse_quadri; 120 bordato) — NON IMPL-A |
