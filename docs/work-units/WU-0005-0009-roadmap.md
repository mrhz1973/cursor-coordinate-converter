...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A+TRACK-SAVE-AS-NAME-A+ROUTING-SUMMARY-DEDUP-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`58197bb`** / **`B6.1RSD-A · build 84`** (ROUTING-SUMMARY-DEDUP-A CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**, **ROUTING-PROFILE-EDIT-A**, **MAP-CENTER-VIEWPORT-AWARE-A**, ….
...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A / ROUTING-PROFILE-EDIT-A / TRACK-PROFILE-POINTS-DISPLAY-A / MAP-CENTER-VIEWPORT-AWARE-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  - **ROUTING-SUMMARY-DEDUP-A build 84 — CLOSED / PASS end-to-end:** tip **`58197bb`**; blob **`79ba3e65…`**; byte LF **3129462**; SHA-256 LF **`db113b40…`**; status solo «Percorso pronto»; card invariate; deploy GIS-only PASS; **QA PASS** «**QA ROUTING-SUMMARY-DEDUP-A PASS operatore**»; display **`B6.1RSD-A · build 84`**.
  ...
  - **Prossimo ordine operativo:** backlog routing UX / **POINT-UNDO-A** / **UNITS-A** / backlog UX profilo (PROFILE-EDIT / POINTS-DISPLAY / MAP-CENTER) / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **ROUTING-SUMMARY-DEDUP-A** tip **`58197bb`** build 84; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**.
