...
**Runtime autorevole attuale:** `d54c915a9c4663ccebe067623bc4f12cdd18e590` (`d54c915`) — display **`B6.0R-A · build 76`**
...
**B2 operativo:** GraphHopper endpoint / richiesta `/route` / preview transiente — **CLOSED / PASS end-to-end** (catena `42b01b3`→`feb1eb3`→tip `89bbf28` build 62; blob `83da60d9…`; endpoint `http://100.114.7.53:8989`; review GPT-sostitutiva pre-deploy PASS; deploy+QA PASS 2026-07-27). Superseded live da **C** → **D** → **E** → **REVERSE-A**.
...
**REVERSE-A (autorità viva monolite):** Inverti percorso — **CLOSED / PASS end-to-end** (tip `d54c915` build 76 / `B6.0R-A`; blob `5c79d266…`; deploy+QA PASS 2026-07-29).
**Backlog UX (docs-only):** **TRACK-ELEVATION-PROFILE-A**; **OUTDOOR-ROUTING-POINT-UNDO-A**; **OUTDOOR-ROUTING-UNITS-A**; **TRACK-MODAL-DISPLAY-PREFS-A** (unità/formato visuale modale Tracce).
