...
**UX-SEARCH-ERROR-FOCUS-A:** **CLOSED / PASS end-to-end** (2026-08-02) — tip storico **`0b27e27`** build 107 / `UX-SEARCH-ERROR-FOCUS-A`; superseded live da **ROUTING-MODAL-OPEN-EXPANDED-A-FIX1**.
**ROUTING-MODAL-OPEN-EXPANDED-A (+ FIX1):** **CLOSED / PASS end-to-end** (2026-08-02) — tip **`89a08fb`** build 109 / `ROUTING-MODAL-OPEN-EXPANDED-A-FIX1`; blob `a1ad55e5…`; byte LF **3287946**; SHA-256 LF **`235ea017…`**; catena `ae28eec` (A · 108) → FIX1; QA FAIL A → FIX1; review+deploy+QA PASS; Regola H.
