...
**STATUS:** OPEN / OPTION-B-IMPL-A-FIX1 IMPLEMENTED — REVIEW GPT-SOSTITUTIVA REQUIRED
**ACTIVE BLOCK:** D-FLIGHT-HIT-TEST-OPTION-B-IMPL-A-FIX1
**CURRENT GATE:** REVIEW GPT-SOSTITUTIVA REQUIRED (candidate build 188 — no deploy)
...
**REVIEW:** GPT-SOSTITUTIVA REQUIRED su FULL SHA `4a66084…`
**SUPERSEDED path:** OPTION-B Automated Browser QA FAIL (TEMP-B CSS) → FIX1
**NEXT:** REVIEW GPT-SOSTITUTIVA → deploy GIS-only + Automated Browser QA (I/J TEMP-B opacity)
<!-- /WU-HOT-HEADER -->
