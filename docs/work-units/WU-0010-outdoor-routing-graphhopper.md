...
**UI-MODAL-ERROR-FOCUS-A-FIX1 (+ FIX2):** **CLOSED / PASS end-to-end** (2026-08-02) — tip **`5fc39e9`** build 111 / `UI-MODAL-ERROR-FOCUS-A-FIX2`; blob `45b9132a…`; byte LF **3293265**; SHA-256 LF **`da5e8f95…`**; catena `6d272d7` (FIX1 · 110) → FIX2; follow-up finding su **UI-MODAL-ERROR-FOCUS-A**; QA FAIL FIX1 → FIX2; Regola H.
