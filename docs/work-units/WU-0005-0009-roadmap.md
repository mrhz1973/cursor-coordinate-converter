...
**B5.4 export JPEG con scala opzionale (2026-06-19):** PASS tecnico statico — dialog `#jpgExportDialog` con checkbox «Includi scala» (default off); `drawJpgExportScale` su canvas 2D prima di `toBlob("image/jpeg")`; riuso `computeMapScaleModel`; nessun `foreignObject`; export base preservato. **B5.4a (2026-06-19):** PASS tecnico — box scala JPG bianco pieno/opaco, contrasto testo/barre; nessun cambio calcoli. **B5.4b (2026-06-19):** PASS tecnico — leggibilità scala JPG export (layout canvas: `textBaseline top`, gap/font/barH/boxH; Nm degradato se canvas basso); box bianco opaco preservato. **B5.4c (2026-06-19):** PASS tecnico — ratio 1:N sempre presente e leggibile nel JPG export; Nm declassabile prima della ratio; box bianco opaco preservato. Browser QA export operatore: pending.
