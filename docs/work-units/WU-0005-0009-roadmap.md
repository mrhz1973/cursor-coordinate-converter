...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`d54c915`** / **`B6.0R-A · build 76`**. **MAJOR-3-b2** resta parcheggiato. Backlog: **TRACK-ELEVATION-PROFILE-A**, **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**, **TRACK-MODAL-DISPLAY-PREFS-A**.
...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-REVERSE-A build 76 — CLOSED / PASS end-to-end:** tip **`d54c915`**; blob **`5c79d266…`**; byte LF **3033162**; SHA-256 LF **`9643ed48…`**; Inverti percorso (swap A/B + reverse via; ID stabili; invalidate preview; no auto-route); deploy GIS-only PASS; **QA PASS** «**QA OUTDOOR-ROUTING-REVERSE-A PASS operatore**»; display **`B6.0R-A · build 76`**.
  ...
  - **TRACK-ELEVATION-PROFILE-A / OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A / TRACK-MODAL-DISPLAY-PREFS-A — backlog / non aperti**.
  - **Prossimo ordine operativo:** backlog routing UX / **TRACK-ELEVATION-PROFILE-A** / **POINT-UNDO-A** / **UNITS-A** / **TRACK-MODAL-DISPLAY-PREFS-A** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **OUTDOOR-ROUTING-REVERSE-A** tip **`d54c915`** build 76; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**.
