...
**Candidato A:** **CLOSED / PASS** → [`WU-0015-dflight-hit-test.md`](WU-0015-dflight-hit-test.md). **Candidato B:** **OPENED** → [`WU-0016-dflight-ux-coherence.md`](WU-0016-dflight-ux-coherence.md) (`OPEN-A` CLOSED docs-only; `TEMPORAL-UX-A` CLOSED/PASS LIVE `aa6e3ce`/193; `LEGEND-ATM09-UX-A` CLOSED/PASS LIVE `0c0f97d`/194; NEXT `AGGIORNA-A`). C–H restano **NOT OPENED**.
...
| **B** | D-Flight UX coherence | **OPENED** → [`WU-0016`](WU-0016-dflight-ux-coherence.md) — B1+B2 CLOSED/PASS; NEXT `AGGIORNA-A` |
