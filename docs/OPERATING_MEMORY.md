...
- **2026-08-24 FIX1 / PENDING QA:** `GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A-FIX1` build **252** — parent 251 FAIL caso 2 (copia multi); await clipboard prima di close dialog; evidence [`orchestrator/inbox/2026-08-24_1500_GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A-FIX1_deploy-abqa.md`](orchestrator/inbox/2026-08-24_1500_GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A-FIX1_deploy-abqa.md)
