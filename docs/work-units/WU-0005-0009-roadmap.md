...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2 CLOSED**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B CLOSED / PASS**; endpoint VPS `http://100.114.7.53:8989`; **OUTDOOR-ROUTING-GH-B2 (+ FIX1 + FIX2) CLOSED / PASS end-to-end** tip **`89bbf28`** build 62. Runtime live monolite **`89bbf28`** / **`B6.0B2-FIX2 · build 62`**. **MAJOR-3-b2** resta parcheggiato.
...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** da scegliere (WU-0010 bundle successivi / geocoding multi-riga backlog / **MAJOR-3-b2** parcheggiato / **TRACK-POINT-CENTER-BUTTON-A**). Runtime live **OUTDOOR-ROUTING-GH-B2** tip **`89bbf28`** build 62; **INFRA-GH-1A/1B CLOSED**.
