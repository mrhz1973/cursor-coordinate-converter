...
| **GATE CORRENTE** | **REVIEW GPT-SOSTITUTIVA REQUIRED** (pre-deploy) |
| **REVIEW BASE** | monolite `488b6c0559810f19bf75aa37d727902b57b9c2b2` (build 185 LIVE) |
| **CANDIDATE RUNTIME** | monolite `7501d0f7f24957f17497357230baebe36b11f298` · build **186** · `APP_BUILD_ID=D-FLIGHT-HIT-TEST-FIX-A-FIX2` |
| **RUNTIME LIVE** | monolite `488b6c0559810f19bf75aa37d727902b57b9c2b2` · build **185** · `APP_BUILD_ID=D-FLIGHT-HIT-TEST-FIX-A-FIX1` · helper prod **0.1.3** (`:8010`) — **non aggiornato** |
| **NEXT** | REVIEW GPT-sostitutiva su FULL SHA candidate FIX2 → deploy solo dopo PASS review |
...
> WU-0015: FIX1 QA operatore **FAIL** (hitOnly invisibile dopo 502 cap). FIX2 candidate `7501d0f` / **186** — visible NFZ fallback. LIVE resta `488b6c0` / **185**. Helper **0.1.3**. Nessun deploy FIX2.
...
1. **D-FLIGHT-HIT-TEST-FIX-A-FIX2** — IMPLEMENTED — REVIEW GPT-SOSTITUTIVA REQUIRED — candidate `7501d0f` / **186**
2. **D-FLIGHT-HIT-TEST-FIX-A-FIX1** — QA OPERATORE FAIL — LIVE `488b6c0` / **185** (superseded come candidate attivo)
