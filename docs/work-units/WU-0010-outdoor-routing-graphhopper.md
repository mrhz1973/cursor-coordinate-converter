...
**ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1 + FIX2 + FIX3):** **CLOSED / PASS end-to-end** (2026-08-02) — tip storico **`0c078ae`** build 105 / `B6.6AR-A-FIX3`; superseded live da **ROUTING-GEOCODE-SNAP-A**.
**ROUTING-GEOCODE-SNAP-A:** **CLOSED / PASS end-to-end** (2026-08-02) — tip **`d1e770e`** build 106 / `ROUTING-GEOCODE-SNAP-A`; blob `204f901c…`; byte LF **3266772**; SHA-256 LF **`98b1e507…`**; preflight `/nearest` + soglie 50/250 + conferma inline; review+deploy+QA PASS; Regola H.
...
**Backlog UX:** **QA-OPERATOR-IT-ONLY-PREF CLOSED / PASS docs-only** (2026-08-01). **Oggetti GIS FROZEN**. **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**. **ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1–FIX3) CLOSED**. **ROUTING-GEOCODE-SNAP-A CLOSED**. Additivi non bloccanti **NON APERTI:** **ROUTING-SEARCH-UX-A** (cronologia 10 + Invio coord; decisione session vs persistenza OPSEC), **UI-MODAL-ERROR-FOCUS-A** (scroll+impulsi errori modal, helper centrale). Resto Bundle F = backlog non aperto.
