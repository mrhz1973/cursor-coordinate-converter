...
1. **GIS-OBJECTS-SETTINGS-RELEGATE-A (+ FIX1)** — **CLOSED / PASS** · LIVE `ac4789e` / **247** · blob `6e10d568…` · QA operatore PASS · Regola H (2026-08-21); accesso Impostazioni + FIX1 toolbar; **Oggetti GIS FROZEN / MAINTENANCE-ONLY**
...
- **Policy 2026-08-21:** **Oggetti GIS = FROZEN / MAINTENANCE-ONLY** (accesso via Impostazioni; `GIS-OBJECTS-SETTINGS-RELEGATE-A (+ FIX1)` **CLOSED / PASS** LIVE **247**); no nuovi sviluppi funzionali; bugfix/stabilità OK; backlog espansione funzionale **non** auto-NEXT; storico preservato
- **Backlog 2026-08-21:** `GIS-OBJECTS-SETTINGS-RELEGATE-A (+ FIX1)` — **CLOSED / PASS** LIVE **247** tip `ac4789e` · blob `6e10d568…` · QA operatore PASS · Regola H; evidence [`orchestrator/inbox/2026-08-21_2300_riepilogo_finito-GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1.md`](orchestrator/inbox/2026-08-21_2300_riepilogo_finito-GIS-OBJECTS-SETTINGS-RELEGATE-A-FIX1.md)
...
- **Bundle 2026-08-22:** `GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A` — **CLOSED / PASS** LIVE **248** tip `aa6e8f5` · blob `dadbf8af…` · QA operatore PASS · Regola H; consuma layout WP + metrics compact; triage FAIL intermedio → no FIX1 (finding residui in backlog); evidence [`orchestrator/inbox/2026-08-22_0215_riepilogo_finito-GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A.md`](orchestrator/inbox/2026-08-22_0215_riepilogo_finito-GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A.md)
- **Bundle 2026-08-22:** `GIS-MAP-UI-RESIDUAL-MAINTENANCE-A` — **CLOSED / PASS** LIVE **249** tip `b264097` · blob `f0bb0be…` · QA operatore PASS · Regola H; consuma 4 residuali (coord format sync · panel dismiss/toolbar · flyout autoclose · WP col resize); evidence [`orchestrator/inbox/2026-08-22_0316_riepilogo_finito-GIS-MAP-UI-RESIDUAL-MAINTENANCE-A.md`](orchestrator/inbox/2026-08-22_0316_riepilogo_finito-GIS-MAP-UI-RESIDUAL-MAINTENANCE-A.md)
- **Bundle 2026-08-22:** `GIS-POLYGON-TABLE-COL-RESIZE-A` — **CLOSED / PASS** LIVE **250** tip `28e87f6` · blob `1482ead…` · QA operatore PASS · Regola H; evidence [`orchestrator/inbox/2026-08-22_0339_riepilogo_finito-GIS-POLYGON-TABLE-COL-RESIZE-A.md`](orchestrator/inbox/2026-08-22_0339_riepilogo_finito-GIS-POLYGON-TABLE-COL-RESIZE-A.md)
- **Backlog 2026-08-22 (NOT OPENED, da triage QA FAIL):** `GIS-WAYPOINT-EDITOR-COORD-FORMAT-FIELD-SYNC-A` · `GIS-POLYGON-PANEL-DISMISS-TOOLBAR-SYNC-A` · `GIS-TRACK-TOOLBAR-FLYOUT-AUTOCLOSE-A` · `GIS-WAYPOINT-TABLE-COL-RESIZE-A`
- **2026-08-24 OPENED / PENDING QA:** `GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A` build **251** — sblocco funzionale limitato a questo blocco; Oggetti GIS FROZEN altrove; evidence [`orchestrator/inbox/2026-08-24_1042_GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A_deploy-abqa.md`](orchestrator/inbox/2026-08-24_1042_GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A_deploy-abqa.md) (storico backlog [`2026-08-21_1210_…`](orchestrator/inbox/2026-08-21_1210_GIS-WAYPOINT-TEXT-EXPORT-CLIPBOARD-A-backlog.md))
