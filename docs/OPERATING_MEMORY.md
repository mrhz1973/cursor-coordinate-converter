...
- **Backlog 2026-08-21 (NOT OPENED):** `MAP-CENTER-VIEWPORT-AWARE-A` **estensione POLYGON PANEL** (dock destro + altezza + no-minimize Nuovo + center useful rect) — core CTA Centra FIX3 **CLOSED**; evidence [`orchestrator/inbox/2026-08-21_1235_MAP-CENTER-VIEWPORT-AWARE-A-polygon-panel-extension.md`](orchestrator/inbox/2026-08-21_1235_MAP-CENTER-VIEWPORT-AWARE-A-polygon-panel-extension.md); piano § EXTENSION in [`2026-08-01_1013_plan_map-center-viewport-aware-a.md`](orchestrator/inbox/2026-08-01_1013_plan_map-center-viewport-aware-a.md)
...
- **Runtime LIVE (post-promozione FIX3):** `GIS-POLYGON-VERTEX-COORD-UX-A-FIX3` build **242** tip `ea5b4c1` · blob `2e0075ba…` · reviewed `eef8303…` — QA operatore PENDING
