...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-GH-B1b (+ FIX1) build 56 — CLOSED / PASS end-to-end:** catena **`3fc67c7`** (55) → tip **`3a702e1`** (56 FIX1); blob **`15c57074…`**; byte LF **2868398**; SHA-256 LF **`789eaefd…`**; pick/marker/GPS + disarmo Routing↔BBOX; review PASS; deploy GIS-only Cursor SSH PASS tip **`3a702e1`**; **QA PASS** «**QA OUTDOOR-ROUTING-GH-B1b PASS operatore**»; **`APP_BUILD_NUM = 56`**. Prossimo **B2**.
  - **OUTDOOR-ROUTING-GH-B1a (+ FIX1 + FIX2) build 54 — CLOSED / PASS end-to-end:** catena **`53e25d6`** (52) → **`3760c77`** (53) → tip **`d95f745`** (54); blob **`06c83dff…`**; byte LF **2843944**; SHA-256 LF **`e7f985dc…`**; shell planner no-map; **QA PASS** «**QA OUTDOOR-ROUTING-GH-B1a PASS operatore**»; **`APP_BUILD_NUM = 54`**. Superseded live da **B1b** `3a702e1`.
  - **Prossimo ordine operativo:** **OUTDOOR-ROUTING-GH-B2** (route GraphHopper; WU-0010 **OPEN / B1a+B1b CLOSED**). **MAJOR-3-b2** resta **parcheggiato**; **MAJOR-4** import/restore backlog basso; **B1b CLOSED** `3a702e1` build 56; **B1a CLOSED** `d95f745` build 54; **MAJOR-3-b1 CLOSED** `1812010` build 51; programma pick Workbench **MAJOR-5A2 completo**; micro-UX **non ora** (salvo bug reale).
