...
- Blocchi futuri:
  ...
  - **INFRA-GH-1D — CLOSED / PASS (2026-07-29):** cutover VPS MMAP+V3 (`nord-ovest-B-v3-elev`; bilinear+ramer max_elevation 5; downtime 11 s; QA «**QA INFRA-GH-1D-EXEC-C PASS operatore**»); V0+backup trattenuti; monolite invariato `567b611`. **Bundle E SBLOCCABILE** (non implementato qui).
