...
- Blocchi futuri:
  ...
  - **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) build 93 — CLOSED / PASS end-to-end:** tip **`d0688ea`**; blob **`55d414bc…`**; byte LF **3149321**; SHA-256 LF **`0c23594c…`**; centra usable + costi normalizzati; review FIX3 PASS; deploy GIS-only PASS; **QA PASS** «**QA MAP-CENTER-VIEWPORT-AWARE-A-FIX3 PASS operatore**»; display **`B6.2MCV-A-FIX3 · build 93`**.
  ...
  - **Prossimo ordine operativo:** backlog UX (PROFILE-EDIT / QA-IT-ONLY) / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **MAP-CENTER-VIEWPORT-AWARE-A-FIX3** tip **`d0688ea`** build 93; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) CLOSED**.
