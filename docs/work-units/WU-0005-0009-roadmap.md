...
- Blocchi futuri:
  ...
  - **ROUTING-PROFILE-EDIT-A — SUPERSEDED / RENAMED — NO RUNTIME**. **QA-OPERATOR-IT-ONLY-PREF — CLOSED / PASS docs-only** (2026-08-01; Regola D1). **QA-CHATGPT-3LINE-HANDOFF-PREF — CLOSED / PASS docs-only** (2026-08-02; Regola D2 — QA via ChatGPT, Dove/Azione/Risultato atteso). **Oggetti GIS — FROZEN**.
