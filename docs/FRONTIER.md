...
| **BLOCCO ATTIVO** | GIS-PANEL-DOCK-MGR-G-BC-BATCH1 |
| **STATO BLOCCO** | LIVE `7e984df` / **212** · deploy+ABQA **78/78 PASS** · gate QA FINALE PENDING |
...
| **NEXT** | QA FINALE CHATGPT → (se PASS operatore) `finito` Regola H; **G-D NOT OPENED**; **F NOT OPENED** |
