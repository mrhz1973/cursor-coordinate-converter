...
**ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2):** **CLOSED / PASS end-to-end** (2026-08-02) — tip storico **`1f7c05f`** build 101 / `B6.5RGM-A-FIX2`; superseded live da **ROUTING-ALTERNATIVE-ROUTES-A**.
**ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1 + FIX2 + FIX3):** **CLOSED / PASS end-to-end** (2026-08-02) — catena `0d14820`→`2728ca2`→`ab432b7`→ tip **`0c078ae`** build 105 / `B6.6AR-A-FIX3`; blob `024986bc…`; byte LF **3236322**; SHA-256 LF **`0770e72d…`**; alternative CH-first + UX FIX1–2 + layout azioni FIX3; review+deploy+QA PASS; Regola H.
...
**Backlog UX:** **QA-OPERATOR-IT-ONLY-PREF CLOSED / PASS docs-only** (2026-08-01). **Oggetti GIS FROZEN**. **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**. **ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1–FIX3) CLOSED**. Resto Bundle F = backlog non aperto.
