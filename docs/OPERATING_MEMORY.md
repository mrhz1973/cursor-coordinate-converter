...
- **Policy 2026-08-21:** **Oggetti GIS = FROZEN / MAINTENANCE-ONLY** (accesso via Impostazioni da `GIS-OBJECTS-SETTINGS-RELEGATE-A` LIVE **246**); no nuovi sviluppi funzionali; bugfix/stabilità OK; backlog espansione funzionale **non** auto-NEXT; storico preservato
- **Backlog 2026-08-21:** `GIS-OBJECTS-SETTINGS-RELEGATE-A` — **LIVE** build **246** tip `f0ea637` · blob `3c575a83…` · QA FINALE PENDING; evidence [`orchestrator/inbox/2026-08-21_2210_GIS-OBJECTS-SETTINGS-RELEGATE-A_deploy-abqa.md`](orchestrator/inbox/2026-08-21_2210_GIS-OBJECTS-SETTINGS-RELEGATE-A_deploy-abqa.md)
