...
1. **GIS-PANEL-DOCK-MGR-G-A1-FIX1** — OPEN · WU-0021 · candidate `c122fd4` / **209** · gate **REVIEW GPT-SOSTITUTIVA — PENDING** · LIVE ancora `7a5c42f`/208
2. **GIS-PANEL-DOCK-MGR-G-A1** — LIVE `7a5c42f` / **208** · QA FAIL circoscritto → FIX1
