...
| **G** | Global minimized-panel dock / modal layout manager | **OPEN** → [`WU-0021`](WU-0021-gis-panel-minimized-dock-manager.md) — G-A1-FIX1 candidate `c122fd4` / **209** · REVIEW-EVIDENCE-B · gate **REVIEW GPT-SOSTITUTIVA — PENDING** · F **NOT OPENED** |
...
**Stato:** **OPEN** in [`WU-0021-gis-panel-minimized-dock-manager.md`](WU-0021-gis-panel-minimized-dock-manager.md) — blocco `GIS-PANEL-DOCK-MGR-G-A1` · candidate `7a5c42f` / build **208** · gate **REVIEW GPT-SOSTITUTIVA — PENDING** (2026-08-16). LIVE ancora `508dd03`/207. **F** resta **NOT OPENED**.
