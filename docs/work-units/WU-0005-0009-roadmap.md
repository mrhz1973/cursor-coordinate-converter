...
| **G** | Global minimized-panel dock / modal layout manager | **OPEN** → [`WU-0021`](WU-0021-gis-panel-minimized-dock-manager.md) — **G-A1-FIX2 CLOSED / PASS** · LIVE `525e7df` / **210** · **G-B NOT OPENED** · F **NOT OPENED** |
...
**Stato:** **OPEN** in [`WU-0021-gis-panel-minimized-dock-manager.md`](WU-0021-gis-panel-minimized-dock-manager.md) — blocco `GIS-PANEL-DOCK-MGR-G-A1-FIX2` **CLOSED / PASS** · LIVE `525e7df` / build **210** · QA operatore PASS · finito Regola H (2026-08-17). **G-B/C/D NOT OPENED**. **F** resta **NOT OPENED**.
