...
**ROUTING-GEOCODE-SNAP-A:** **CLOSED / PASS end-to-end** (2026-08-02) — tip storico **`d1e770e`** build 106 / `ROUTING-GEOCODE-SNAP-A`; superseded live da **UX-SEARCH-ERROR-FOCUS-A**.
**UX-SEARCH-ERROR-FOCUS-A:** **CLOSED / PASS end-to-end** (2026-08-02) — tip **`0b27e27`** build 107 / `UX-SEARCH-ERROR-FOCUS-A`; blob `c56b4a35…`; byte LF **3285428**; SHA-256 LF **`25988cb5…`**; chiude **ROUTING-SEARCH-UX-A** + **UI-MODAL-ERROR-FOCUS-A**; ROUTINE; harness 38/38; deploy+QA PASS; Regola H.
