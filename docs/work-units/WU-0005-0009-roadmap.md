...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`d28bc44`** / **`B6.0ES-A · build 78`** (OUTDOOR-ROUTING-ELEVATION-STYLE-A CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **TRACK-ELEVATION-PROFILE-A**, **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**.
...
- Blocchi futuri:
  ...
  - **TRACK-ELEVATION-PROFILE-A / OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A — backlog / non aperti**.
  - **Prossimo ordine operativo:** backlog routing UX / **TRACK-ELEVATION-PROFILE-A** / **POINT-UNDO-A** / **UNITS-A** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **OUTDOOR-ROUTING-ELEVATION-STYLE-A** tip **`d28bc44`** build 78; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**.
