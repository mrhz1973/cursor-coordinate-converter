...
| **GATE CORRENTE** | REVIEW GPT-SOSTITUTIVA REQUIRED (pre-deploy; **no** deploy) |
...
| **NEXT** | REVIEW PRE-DEPLOY sul FULL SHA FIX1 — poi eventuale deploy (fuori da questo intervento) |
...
> WU-0015 FIX1: candidate `488b6c0` / build **185**; FIX-A `62de84e` / 184 = REVIEW FAIL superseded. LIVE resta **183**. Helper **0.1.3** invariato.
...
1. **D-FLIGHT-HIT-TEST-FIX-A-FIX1** — IMPLEMENTED — REVIEW REQUIRED — candidate `488b6c0` / build **185** (LIVE resta 183)
...
4. **D-FLIGHT-TEMPORAL-FILTER-UI-A-FIX3** — CLOSED / PASS end-to-end (build **183** / `20b1b49` LIVE) — WU-0014 CLOSED
