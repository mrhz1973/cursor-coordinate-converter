...
- **WU-0008 8d-B EOX:** pre-check prerequisiti **PASS** (read-only, HEAD `9f98c5d`); dettagli in [`docs/work-units/WU-0005-0009-roadmap.md`](work-units/WU-0005-0009-roadmap.md) §8d-B. Prompt runtime EOX **parcheggiato**; licenza/hosting gate bloccante.
