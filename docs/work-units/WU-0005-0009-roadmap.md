...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A+TRACK-SAVE-AS-NAME-A+ROUTING-SUMMARY-DEDUP-A+ROUTING-UX-POLISH-BUNDLE-A (+ FIX1)+APP-BUILD-LABEL-UX-A (+ FIX1)+TRACK-PROFILE-POINTS-DISPLAY-A+MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3)+ROUTING-POINT-COORD-EDIT-A (+ FIX1) CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`cad28e7`** / **`B6.4IHA-B2-FIX1 · build 98`** (**MAJOR-3-b2 (+ FIX1)** CLOSED; tip TPC storico `0482ef8`). **MAJOR-3-b2 CLOSED**. Backlog: **QA-OPERATOR-IT-ONLY-PREF**, **ROUTING-GEOCODING-MULTIROW-A**, ….
...
- Blocchi futuri:
  ...
  - **ROUTING-PROFILE-EDIT-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  ...
  - **Prossimo ordine operativo:** backlog UX (QA-IT-ONLY) / **ROUTING-GEOCODING-MULTIROW-A** / Bundle F. Runtime live monolite **MAJOR-3-b2 (+ FIX1)** tip **`cad28e7`** build 98 (documentale tip **`80265c3`**); GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) CLOSED**; **ROUTING-POINT-COORD-EDIT-A (+ FIX1) CLOSED**; **TRACK-POINT-CENTER-BUTTON-A CLOSED**; **MAJOR-3-b2 (+ FIX1) CLOSED**.
