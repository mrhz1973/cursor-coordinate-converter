...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / PLAN APPROVED / RUNTIME NOT STARTED**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). Review upstream GLM **PASS CON CORREZIONI**; split **B1 + B2** ratificato; prossimo bundle autorizzabile **B1** (richiede prompt Cursor dedicato + review downstream pre-deploy). Runtime autorevole invariato `1812010` build 51. **MAJOR-3-b2** resta parcheggiato.
...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** **OUTDOOR-ROUTING-GH** è il **programma corrente pianificato** — [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md) **OPEN / PLAN APPROVED / RUNTIME NOT STARTED** (review GLM **PASS CON CORREZIONI**; split **B1+B2** ratificato; prossimo bundle autorizzabile **B1**, build futuro 52, richiede prompt Cursor dedicato + review downstream pre-deploy). **MAJOR-3-b2** (apply additivo Import Hub) resta **parcheggiato** (non annullato); **MAJOR-4** import/restore backlog basso; **MAJOR-3-b1 CLOSED** `1812010` build 51; **OFFLINE-DOWNLOAD-CONTROLS-A CLOSED** `fb11986` build 50; **TRACK-CREATE-EDIT-UX-A CLOSED** `793f4cb` build 46; **TRACK-BRUSH-ANTIMERIDIAN CLOSED** `9cc7937` build 44; **TRACK-BRUSH-A CLOSED** `d4f877a` build 42; **TRACK-STYLE-A CLOSED** `40c97b6` build 38; **IMPORT-DROP-B + TRACK-MODAL-UX-A CLOSED** `1d28163` build 35; **IMPORT-DROP-A CLOSED** `5f57a75` build 34; **MAJOR-4-a CLOSED** `73269a0` build 33; **MAJOR-3-a CLOSED** `c0fb4da` build 32; programma pick Workbench **MAJOR-5A2 completo**; titolo statico `<title>` e micro-UX **non ora** (salvo bug reale).
