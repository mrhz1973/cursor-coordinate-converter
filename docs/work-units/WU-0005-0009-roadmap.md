...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A+TRACK-SAVE-AS-NAME-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`8a641bc`** / **`B6.1TSN-A · build 83`** (TRACK-SAVE-AS-NAME-A CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**, **ROUTING-PROFILE-EDIT-A**, **MAP-CENTER-VIEWPORT-AWARE-A**, **ROUTING-SUMMARY-DEDUP-A**, ….
...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A / ROUTING-PROFILE-EDIT-A / TRACK-PROFILE-POINTS-DISPLAY-A / MAP-CENTER-VIEWPORT-AWARE-A / ROUTING-SUMMARY-DEDUP-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  - **ROUTING-SUMMARY-DEDUP-A — BACKLOG / NON APERTO:** Riepilogo Routing senza metriche duplicate — riga «Percorso pronto» solo stato sintetico (+ loading/avvisi/errori); distanza/tempo/dislivelli restano nelle card; emerso QA TRACK-SAVE-AS-NAME-A (**non** FAIL); **nessuna** priorità runtime automatica.
  - **TRACK-SAVE-AS-NAME-A build 83 — CLOSED / PASS end-to-end:** tip **`8a641bc`**; blob **`be95db55…`**; byte LF **3130487**; SHA-256 LF **`cacd9360…`**; form inline nome pre-salvataggio; review GPT-sostitutiva PASS; deploy GIS-only PASS; **QA PASS** «**QA TRACK-SAVE-AS-NAME-A PASS operatore**»; display **`B6.1TSN-A · build 83`**.
  - **Prossimo ordine operativo:** backlog routing UX / **POINT-UNDO-A** / **UNITS-A** / backlog UX profilo (PROFILE-EDIT / POINTS-DISPLAY / MAP-CENTER) / **ROUTING-SUMMARY-DEDUP-A** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **TRACK-SAVE-AS-NAME-A** tip **`8a641bc`** build 83; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**.
