...
| Pulizia contenuto descrittivo Dettagli | Markup HTML/entity in Dettagli D-Flight e ATM09 Rule/Regola. **CLOSED / PASS** LIVE `d899cff` / **238** (FIX1 237 generic + FIX2 ATM09 `dflightAtm09OpenDetails`, 2026-08-21). Casa generale: [roadmap Map UX + D-Flight details](WU-0005-0009-roadmap.md) | `D-FLIGHT-DETAILS-CONTENT-CLEANUP-A (+ FIX1 + FIX2)` |
| ATM09 Dettagli: leggibilità + link sicuri | Residuo UX post-QA FIX2: link cliccabili sicuri da URL estratti/validati (no raw HTML execution); tipografia/spaziatura/contrasto del pannello ATM09; dark/black base ispirata D-Flight. Baseline sicuro = build **238**. **BACKLOG / NOT OPENED**. Casa generale: [roadmap Map UX + D-Flight details](WU-0005-0009-roadmap.md) | `D-FLIGHT-ATM09-DETAILS-READABILITY-LINKS-A` |
| Cleanup overlay/legenda alla **chiusura** del modal | Alla close completa del modal D-Flight devono sparire: legenda D-Flight; tutte le zone; tutti gli overlay/geometrie della sessione modal — teardown **immediato** (FIX1). Dopo close: nessuna legenda o zona D-Flight visibile sulla mappa. **Non** cambia minimize/restore né auto-reload al reopen. **CLOSED / PASS** LIVE `4f00433` / **235** (2026-08-20). Casa generale: [roadmap Map UX + D-Flight details](WU-0005-0009-roadmap.md) | `D-FLIGHT-CLOSE-CLEANUP-A (+ FIX1)` |
| Hard no-overlap legende ↔ barre coordinate | Legenda D-Flight e ATM09 **non** possono mai sovrapporsi alle barre/aree coordinate (HARD EXCLUSION). SUPERSEDES «overlap se touched» di F-BATCH1. **Non** riaprire WU-0018. Casa: [roadmap §8 GIS-LEGENDS-NO-OVERLAP-COORD-BARS-A](WU-0005-0009-roadmap.md) | `GIS-LEGENDS-NO-OVERLAP-COORD-BARS-A` |
