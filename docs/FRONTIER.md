...
| **BLOCCO ATTIVO** | D-FLIGHT-PANEL-SIDEBYSIDE-IMPL-A-FIX2 (**IMPLEMENTED / SELFTEST PASS / REVIEW GPT-SOSTITUTIVA — PENDING**) |
| **STATO BLOCCO** | FIX2 symmetric vertical pick + partial_visible · candidato `a40d216` / build **203** · LIVE resta **200** fino a deploy post-review |
...
| **NEXT** | REVIEW GPT-SOSTITUTIVA su `a40d216` — evidence [`inbox/2026-08-16_1815_…fix2-evidence.md`](orchestrator/inbox/2026-08-16_1815_dflight-panel-sidebyside-impl-a-fix2-evidence.md) → solo dopo PASS: deploy GIS + ABQA |
