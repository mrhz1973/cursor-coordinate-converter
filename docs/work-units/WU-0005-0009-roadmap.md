...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D CLOSED**; **Bundle E SBLOCCABILE**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`567b611`** / **`B6.0D-FIX1 · build 66`**. **MAJOR-3-b2** resta parcheggiato. Backlog: **OUTDOOR-ROUTING-REVERSE-A**.
...
- Blocchi futuri:
  ...
  - **INFRA-GH-1D — CLOSED / PASS end-to-end (2026-07-29):** cutover VPS MMAP+V3 (`nord-ovest-B-v3-elev`; bilinear+ramer max_elevation 5; downtime 11 s; QA «**QA INFRA-GH-1D-EXEC-C PASS operatore**»); V0+backup trattenuti; monolite invariato `567b611`; **finito Regola H** (correzione coda EXEC-C). **Bundle E SBLOCCABILE** (non implementato qui).
  ...
  - **Prossimo ordine operativo:** **Bundle E** (sbloccabile) oppure **OUTDOOR-ROUTING-REVERSE-A** / backlog routing UX / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A**. Runtime live monolite **OUTDOOR-ROUTING-GH-D** tip **`567b611`** build 66; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**.
