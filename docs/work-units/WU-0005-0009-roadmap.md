...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C CLOSED**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B CLOSED / PASS**; **OUTDOOR-ROUTING-GH-C (+ FIX1) CLOSED / PASS end-to-end** tip **`dd9ad2f`** build 64. Runtime live monolite **`dd9ad2f`** / **`B6.0C-FIX1 · build 64`**. **MAJOR-3-b2** resta parcheggiato.
...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** da scegliere (WU-0010 D/E/F / backlog routing UX / geocoding multi-riga / **MAJOR-3-b2** parcheggiato / **TRACK-POINT-CENTER-BUTTON-A**). Runtime live **OUTDOOR-ROUTING-GH-C** tip **`dd9ad2f`** build 64; **INFRA-GH-1A/1B CLOSED**.
