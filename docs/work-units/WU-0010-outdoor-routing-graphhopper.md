...
**ROUTING-ANDATA-RITORNO-A:** **CLOSED / PASS end-to-end** (2026-08-03) — tip **`c1a6c89`** build 112 / `ROUTING-ANDATA-RITORNO-A`; blob `0d8824e0…`; byte LF **3308964**; SHA-256 LF **`71f7bb1b…`**; due POST `/route` sequenziali out-and-back; session-only `routeMode`; DELICATO; review PASS PRE-DEPLOY; deploy+QA PASS; Regola H.
