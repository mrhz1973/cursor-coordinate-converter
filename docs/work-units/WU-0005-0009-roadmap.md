...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A+TRACK-SAVE-AS-NAME-A+ROUTING-SUMMARY-DEDUP-A+ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`173b6cb`** / **`B6.2UX-A-FIX1 · build 86`** (ROUTING-UX-POLISH-BUNDLE-A-FIX1 CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **ROUTING-PROFILE-EDIT-A**, **MAP-CENTER-VIEWPORT-AWARE-A**, **APP-BUILD-LABEL-UX-A**, ….
...
- Blocchi futuri:
  ...
  - **ROUTING-PROFILE-EDIT-A / TRACK-PROFILE-POINTS-DISPLAY-A / MAP-CENTER-VIEWPORT-AWARE-A / QA-OPERATOR-IT-ONLY-PREF / APP-BUILD-LABEL-UX-A — backlog / non aperti**.
  - **APP-BUILD-LABEL-UX-A — BACKLOG / NON APERTO:** rimuovere badge build completo dalla barra superiore mappa; tenere build in footer + Informazioni/About; altri indicatori topbar invariati; UX ROUTINE futura; **nessuna** implementazione ora.
  - **OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A — CLOSED / ASSORBITI** in ROUTING-UX-POLISH-BUNDLE-A (+ FIX1).
  - **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) build 86 — CLOSED / PASS end-to-end:** catena **`7653ee7`** (85) → tip **`173b6cb`** (86 FIX1); blob **`9686245e…`**; byte LF **3150227**; SHA-256 LF **`4c197243…`**; undo storico + unità session + feedback + badge + focus; deploy GIS-only PASS; **QA PASS** «**QA ROUTING-UX-POLISH-BUNDLE-A-FIX1 PASS operatore**»; display **`B6.2UX-A-FIX1 · build 86`**.
  - **ROUTING-SUMMARY-DEDUP-A build 84 — CLOSED / PASS end-to-end:** tip storico **`58197bb`**; blob **`79ba3e65…`**; byte LF **3129462**; SHA-256 LF **`db113b40…`**; status solo «Percorso pronto»; card invariate; deploy GIS-only PASS; **QA PASS** «**QA ROUTING-SUMMARY-DEDUP-A PASS operatore**»; display **`B6.1RSD-A · build 84`**; superseded live da UX-POLISH.
  ...
  - **Prossimo ordine operativo:** backlog UX profilo (PROFILE-EDIT / POINTS-DISPLAY / MAP-CENTER) / **QA-OPERATOR-IT-ONLY-PREF** / **APP-BUILD-LABEL-UX-A** / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **ROUTING-UX-POLISH-BUNDLE-A-FIX1** tip **`173b6cb`** build 86; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**.
