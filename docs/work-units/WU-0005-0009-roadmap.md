...
- Blocchi futuri:
  ...
  - **P-POLYGON-LIST-UX-NEXT — backlog candidato (A chiuso; B pending):** **(A) rinomina inline** — **CLOSED** (`6892890`, QA PASS); **(B) colonne ridimensionabili** — prossimo candidato operativo. Emerso da QA FIX2 — non blocca P-POLYGON-LIST-ENRICHMENT CLOSED.
  ...
  - **Prossimo ordine operativo:** **P-POLYGON-LIST-UX-NEXT-B** colonne ridimensionabili.
...
**Prossimo ordine operativo candidato:** **P-POLYGON-LIST-UX-NEXT-B** colonne ridimensionabili.
...
**Prossimo candidato:** **P-POLYGON-LIST-UX-NEXT-B** — colonne ridimensionabili.
