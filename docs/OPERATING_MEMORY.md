...
| **BLOCCO ATTIVO** | D-FLIGHT-HIT-TEST-FIX-A-FIX1 |
| **STATO BLOCCO** | **DEPLOYED — AUTOMATED BROWSER QA PASS** |
| **GATE CORRENTE** | **QA FINALE CHATGPT — PENDING** |
| **REVIEW BASE** | monolite `488b6c0559810f19bf75aa37d727902b57b9c2b2` (build 185) |
| **RUNTIME LIVE** | monolite `488b6c0559810f19bf75aa37d727902b57b9c2b2` · build **185** · `APP_BUILD_ID=D-FLIGHT-HIT-TEST-FIX-A-FIX1` · helper prod **0.1.3** (`:8010`) |
| **NEXT** | QA umana residua (ChatGPT) → `QA D-FLIGHT-HIT-TEST-FIX-A-FIX1 PASS operatore` → auto-`finito` |
...
> WU-0015 FIX1 LIVE `488b6c0` / **185** su `:8000`. Automated Browser QA PASS. Helper **0.1.3**. FIX-A 184 non deployato.
...
1. **D-FLIGHT-HIT-TEST-FIX-A-FIX1** — DEPLOY PASS + AUTOMATED BROWSER QA PASS — LIVE `488b6c0` / **185** — QA FINALE PENDING
2. **D-FLIGHT-HIT-TEST-FIX-A** — REVIEW FAIL / BLOCKING — `62de84e` / 184 superseded (non deployato)
3. **D-FLIGHT-HIT-TEST-DIAG-A** — DIAGNOSTIC COMPLETE — ROOT CAUSE CONFIRMED — WU-0015 OPEN
4. **D-FLIGHT-TEMPORAL-FILTER-UI-A-FIX3** — CLOSED / PASS end-to-end (build **183** historical) — WU-0014 CLOSED
5. **DOCS-DFLIGHT-WU0014-OPEN-A** — CLOSED / PASS DOCS-ONLY — apertura WU-0014
