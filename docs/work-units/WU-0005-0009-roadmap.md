...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D+E+REVERSE-A+ELEVATION-STYLE-A+TRACK-ELEVATION-PROFILE-A CLOSED**; Bundle F futuro) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B/1D CLOSED / PASS**; GraphHopper VPS live **V3** (`nord-ovest-B-v3-elev`). Runtime live monolite **`1fc9d70`** / **`B6.1TP-A-FIX3 · build 82`** (TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED). **MAJOR-3-b2** resta parcheggiato. Backlog: **OUTDOOR-ROUTING-POINT-UNDO-A**, **OUTDOOR-ROUTING-UNITS-A**, **TRACK-SAVE-AS-NAME-A**, **MAP-CENTER-VIEWPORT-AWARE-A**, ….
...
- Blocchi futuri:
  ...
  - **OUTDOOR-ROUTING-POINT-UNDO-A / OUTDOOR-ROUTING-UNITS-A / TRACK-SAVE-AS-NAME-A / ROUTING-PROFILE-EDIT-A / TRACK-PROFILE-POINTS-DISPLAY-A / MAP-CENTER-VIEWPORT-AWARE-A / QA-OPERATOR-IT-ONLY-PREF — backlog / non aperti**.
  - **Prossimo ordine operativo:** backlog routing UX / **POINT-UNDO-A** / **UNITS-A** / backlog UX profilo / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **TRACK-ELEVATION-PROFILE-A-FIX3** tip **`1fc9d70`** build 82; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**.
