...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** backlog routing UX / **POINT-UNDO-A** / **UNITS-A** / backlog UX profilo (PROFILE-EDIT / POINTS-DISPLAY / MAP-CENTER) / geocoding multi-riga / **MAJOR-3-b2** / **TRACK-POINT-CENTER-BUTTON-A** / Bundle F. Runtime live monolite **TRACK-SAVE-AS-NAME-A** tip **`8a641bc`** build 83; GH VPS **V3**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**.
