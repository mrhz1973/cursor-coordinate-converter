...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** backlog non aperto (**Bundle F**) — **nessun** candidato runtime aperto automaticamente. Runtime live monolite **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2)** tip **`1f7c05f`** build 101; GH VPS **V3**; **QA-CHATGPT-3LINE-CURSOR-RULES-A CLOSED**; **QA-CHATGPT-3LINE-HANDOFF-PREF CLOSED**; **QA-OPERATOR-IT-ONLY-PREF CLOSED**; **Oggetti GIS FROZEN**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) CLOSED**; **ROUTING-POINT-COORD-EDIT-A (+ FIX1) CLOSED**; **TRACK-POINT-CENTER-BUTTON-A CLOSED**; **MAJOR-3-b2 (+ FIX1) CLOSED**; **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**.
