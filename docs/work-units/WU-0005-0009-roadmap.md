...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** backlog non aperto (resto **Bundle F**) — **nessun** candidato runtime aperto automaticamente. Runtime live monolite **ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1–FIX3)** tip **`0c078ae`** build 105 (**invariato**); GH VPS **V3**; **L10N-EN-FR-FREEZE-A CLOSED**; **ROUTING-ALTERNATIVE-ROUTES-A CLOSED**; **QA-CHATGPT-3LINE-CURSOR-RULES-A CLOSED**; **QA-CHATGPT-3LINE-HANDOFF-PREF CLOSED**; **QA-OPERATOR-IT-ONLY-PREF CLOSED**; **Oggetti GIS FROZEN**; **INFRA-GH-1A/1B/1D CLOSED**; **Bundle E CLOSED**; **REVERSE-A CLOSED**; **TRACK-MODAL-DISPLAY-PREFS-A CLOSED**; **ELEVATION-STYLE-A CLOSED**; **TRACK-ELEVATION-PROFILE-A + FIX1–FIX3 CLOSED**; **TRACK-SAVE-AS-NAME-A CLOSED**; **ROUTING-SUMMARY-DEDUP-A CLOSED**; **ROUTING-UX-POLISH-BUNDLE-A (+ FIX1) CLOSED**; **APP-BUILD-LABEL-UX-A (+ FIX1) CLOSED**; **TRACK-PROFILE-POINTS-DISPLAY-A CLOSED**; **MAP-CENTER-VIEWPORT-AWARE-A (+ FIX1–FIX3) CLOSED**; **ROUTING-POINT-COORD-EDIT-A (+ FIX1) CLOSED**; **TRACK-POINT-CENTER-BUTTON-A CLOSED**; **MAJOR-3-b2 (+ FIX1) CLOSED**; **ROUTING-GEOCODING-MULTIROW-A (+ FIX1 + FIX2) CLOSED**.
  - **L10N-EN-FR-FREEZE-A — CLOSED / PASS docs-only (governance trasversale, 2026-08-02):** IT attiva per nuove stringhe; EN/FR expansion frozen; i18n esistente preservato; unfreeze solo esplicito; rule `.cursor/rules/32-l10n-en-fr-freeze.mdc`; **non** feature runtime; **non** lavoro traduzione/migrazione; **non** apre Bundle F; monolite tip **`0c078ae`** invariato.
  - **ROUTING-ALTERNATIVE-ROUTES-A (+ FIX1–FIX3) build 105 — CLOSED / PASS end-to-end:** catena **`0d14820`** (102) → **`2728ca2`** (103 FIX1) → **`ab432b7`** (104 FIX2) → tip **`0c078ae`** (105 FIX3); blob **`024986bc…`**; byte LF **3236322**; SHA-256 LF **`0770e72d…`**; alternative CH-first + UX + layout azioni; review+deploy+QA PASS «**QA ROUTING-ALTERNATIVE-ROUTES-A-FIX3 PASS operatore**»; display **`B6.6AR-A-FIX3 · build 105`**.
