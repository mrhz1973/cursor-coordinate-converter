...
| **BLOCCO ATTIVO** | GIS-PANEL-DOCK-MGR-G-A1-FIX1-REVIEW-EVIDENCE-B |
| **STATO BLOCCO** | Evidence-B docs-only · candidate `c122fd4` / **209** **invariato** · 18 hunk +217/−40 OTHER=0 · **non deployato** |
...
| **RUNTIME LIVE** | `7a5c42f3708cfa3dff3f7a7a7e1fdab5e470066c` · build **208** · helper prod **0.1.3** *(FIX1 non LIVE)* |
| **NEXT** | REVIEW GPT-SOSTITUTIVA (evidence-B) → (se PASS) deploy+ABQA; **F NOT OPENED**; G-B/C/D NOT OPENED; WU-0012 OPEN |
