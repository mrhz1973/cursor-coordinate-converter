...
| Cleanup overlay/legenda alla **chiusura** del modal | Alla close completa del modal D-Flight devono sparire: legenda D-Flight; tutte le zone; tutti gli overlay/geometrie della sessione modal. Dopo close: nessuna legenda o zona D-Flight visibile sulla mappa. **Non** cambia minimize/restore. **Non** aperto. Casa generale: [roadmap Map UX + D-Flight details](WU-0005-0009-roadmap.md) | `D-FLIGHT-CLOSE-CLEANUP-A` |
