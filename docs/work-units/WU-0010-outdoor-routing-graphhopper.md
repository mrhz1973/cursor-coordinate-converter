...
**STATUS:** OPEN / Bundle F avoid-areas — **OUTDOOR-ROUTING-F-AVOID-AREAS-A-FIX1** candidate build **219**
**ACTIVE BLOCK:** `OUTDOOR-ROUTING-F-AVOID-AREAS-A-FIX1`
**CURRENT GATE:** **REVIEW GPT-SOSTITUTIVA — PENDING**
**RUNTIME LIVE:** `1e37e56f04ddb9e7aec2598b398739e7772cec6f` · build **217** (monolite servito)
**RUNTIME CANDIDATE:** `5477a5e0d8d9a5681dbfab37b3c39e182306fc79` · build **219** · `OUTDOOR-ROUTING-F-AVOID-AREAS-A-FIX1`
**NEXT:** review candidato 219 · no deploy
<!-- /WU-HOT-HEADER -->
