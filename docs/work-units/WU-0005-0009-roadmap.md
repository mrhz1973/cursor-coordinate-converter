...
| **G** | Global minimized-panel dock / modal layout manager | **OPEN** → [`WU-0021`](WU-0021-gis-panel-minimized-dock-manager.md) — AUDIT-A + EVIDENCE-B · gate **REVIEW PENDING** · G-A1 · LIVE `508dd03` / **207** · F **NOT OPENED** |
...
**Stato:** **OPEN** in [`WU-0021-gis-panel-minimized-dock-manager.md`](WU-0021-gis-panel-minimized-dock-manager.md) — blocco `GIS-PANEL-DOCK-MGR-AUDIT-A-EVIDENCE-B` · LIVE `508dd03` / build **207** · gate **REVIEW PENDING** (2026-08-16). Root cause z CONFIRMED · **G-A1** shared host · z 29/28/30. **F** resta **NOT OPENED**.
