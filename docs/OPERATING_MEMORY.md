...
- **Bundle 2026-08-22:** `GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A` — IMPLEMENTED · deploy/ABQA PASS · **QA FAIL operatore** → triage **no FIX1** (finding preesistenti vs LIVE **247**); candidate **248** non promosso; obiettivi layout+metrics preservati; evidence [`orchestrator/inbox/2026-08-22_0155_GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A-QA-FAIL-triage.md`](orchestrator/inbox/2026-08-22_0155_GIS-WAYPOINT-POLYGON-UI-MAINTENANCE-A-QA-FAIL-triage.md)
