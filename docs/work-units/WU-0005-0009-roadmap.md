...
6. **WU-0010 — Outdoor Routing GraphHopper** (programma corrente, **OPEN / B1a+B1b+B2+C+D CLOSED**) — vedi [`WU-0010-outdoor-routing-graphhopper.md`](WU-0010-outdoor-routing-graphhopper.md). **INFRA-GH-1A/1B CLOSED / PASS**; **OUTDOOR-ROUTING-GH-D (+ FIX1) CLOSED / PASS end-to-end** tip **`567b611`** build 66. Runtime live monolite **`567b611`** / **`B6.0D-FIX1 · build 66`**. **MAJOR-3-b2** resta parcheggiato.
...
- Blocchi futuri:
  ...
  - **Prossimo ordine operativo:** da scegliere (WU-0010 E/F / backlog routing UX / geocoding multi-riga / **MAJOR-3-b2** parcheggiato / **TRACK-POINT-CENTER-BUTTON-A**). Runtime live **OUTDOOR-ROUTING-GH-D** tip **`567b611`** build 66; **INFRA-GH-1A/1B CLOSED**.
